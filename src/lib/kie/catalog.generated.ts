    ...
    fields: [
      {
        ...
        label: 'Prompt',
        required: true,
        description: 'Text instructions describing the required movement of the video.',
      },
      {
        name: 'extend_at',
        kind: 'number',
        ...
        step: 1,
        default: 2,
        description: 'The starting position of the video extension.',
      },
      {
        name: 'extend_times',
        kind: 'number',
        ...
        step: 1,
        default: 1,
        description: 'Duration of video extension (in seconds).',
      },
      {
        name: 'task_id',
        kind: 'text',
