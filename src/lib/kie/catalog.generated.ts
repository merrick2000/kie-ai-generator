  ...
  },
  {
    ...
    fields: [
      ...
      nsfwChecker(),
      {
        ...
        maxItems: 10,
        accepts: 'WAV, MP3 · 2 to 30 s each',
        maxSizeMb: 15,
        description: 'A voice, music or sound for the video to follow.',
        excludes: ['first_frame_url', 'last_frame_url'],
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Reference audio',
        maxItems: 3,
        accepts: 'WAV, MP3 · 2 to 15 s each',
        maxSizeMb: 15,
        description: 'A voice, music or sound for the video to follow.',
      },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      seed(),
      {
        name: 'character_ids',
        kind: 'library',
        source: 'omni-characters',
        label: 'Characters',
        maxItems: 7,
        description: 'Made in Characters. Each one uses an image slot.',
      },
      {
        name: 'audio_ids',
        kind: 'library',
        ...
        label: 'Voices',
        maxItems: 3,
        description: 'Voices designed in Characters, for narration or dialogue.',
      },
    ],
  },
  {
