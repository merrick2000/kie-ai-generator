...
const IMAGE_EDIT: ModelDef[] = [
  ...
  {
    // Kie publishes GPT Image 2.5 in two variants, Flare and Sunburst, with
    // identical parameters and no word on how they differ. Carried as it
    // documents them, without a claim the docs do not make.
    ...
    api: 'market',
    output: 'image',
    tagline: 'GPT Image 2.5, Flare variant. Long briefs, up to 4K.',
    speed: 'balanced',
    badges: ['4K'],
    routeWithAssets: {
    ...
    fields: [
      prompt({ maxLength: 20000 }),
      optionalReference(16, {
        label: 'Reference images',
        description:
          'Optional. Adding one guides the result instead of generating from the prompt alone.',
      }),
      ratio(['auto', '1:1', '3:2', '2:3', '4:3', '3:4', '16:9', '9:16', '21:9', '27:16', '16:27', '9:8', '8:9'], 'auto'),
      resolution(['1K', '2K', '4K'], '1K'),
      {
        name: 'background',
        kind: 'select',
        ...
        options: opts('auto', 'transparent', 'opaque'),
        default: 'auto',
        description: '27:16, 16:27, 9:8 and 8:9 render at 1K only.',
        advanced: true,
      },
    ],
  },
  {
    ...
    api: 'market',
    output: 'image',
    tagline: 'GPT Image 2.5 Flare, editing from up to 16 source images.',
    speed: 'balanced',
    hidden: true,
    fields: [
      prompt({ maxLength: 20000 }),
  ...
  },
  {
    ...
    api: 'market',
    output: 'image',
    tagline: 'GPT Image 2.5, Sunburst variant. Long briefs, up to 4K.',
    speed: 'balanced',
    badges: ['4K'],
    routeWithAssets: {
  ...
  },
  {
    ...
    api: 'market',
    output: 'image',
    tagline: 'GPT Image 2.5 Sunburst, editing from up to 16 source images.',
    speed: 'balanced',
    hidden: true,
    fields: [
      prompt({ maxLength: 20000 }),
